...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-b5389388');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-b5389388');}
...
function clearFlash(){dieView.classList.remove('rl-win-b5389388');dieView.classList.remove('rl-lose-b5389388');if(frameEl){frameEl.classList.remove('rl-win-b5389388');frameEl.classList.remove('rl-lose-b5389388');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-b5389388');if(frameEl){frameEl.classList.add('rl-win-b5389388');}}else{dieView.classList.add('rl-lose-b5389388');if(frameEl){frameEl.classList.add('rl-lose-b5389388');}}
...
var brandEl=document.querySelector('.rl-brand-b5389388');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
